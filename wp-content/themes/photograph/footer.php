				 ...
				 if ( is_active_sidebar( 'photograph_footer_options' ) ) :
					...
					<div class="copyright">
						<a title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" target="_blank" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_bloginfo( 'name', 'display' ); ?></a> | 
									<a href="http://davidefiammenghi.com" title="Davide Fiammenghi" target="_blank">www.davidefiammenghi.com</a> | <?php echo '&copy; ' . esc_attr__('2019 All rights reserved ','photograph'); ?>
						<?php
